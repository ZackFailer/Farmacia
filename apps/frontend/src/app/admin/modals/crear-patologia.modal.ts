...
import type { CreatePatologiaDto } from '../../shared/models/patologia.model';
...
@Component({
  ...
  template: `
    <ion-header>
      <ion-toolbar>
        <ion-title>Nueva Patología</ion-title>
    ...
    <ion-content class="ion-padding">
      <form [formGroup]="form">
        <ion-item>
          ...
          <ion-input formControlName="nombre" placeholder="Ej: Hipertensión"></ion-input>
        </ion-item>
...
export class CrearPatologiaModal {
  ...
  guardar(): void {
    ...
    this.modalCtrl.dismiss(this.form.value as CreatePatologiaDto, 'confirm');
  }
